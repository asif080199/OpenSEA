...
#ifndef REPDIRECTIONS_H
#define REPDIRECTIONS_H
#include "report.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief Report of all wave directions used in the oFreq run.
 *
 * Provides a report of all wave directions used in the oFreq run.  Report written to the main project folder.  Not
 * part of the subfolders.
 */
class repDirections : public Report
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
     ...
     */
    repDirections(ofreq::ReportManager *ptIn);
