...
#ifndef REPDESIGNACCEL_H
#define REPDESIGNACCEL_H
#include "report.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief Report for design accelerations.  (local motions, plus static gravity.)
 *
 * Provides the components of design acceleration at a specific location the body.  The design acceleration
 * accounts for maximum body motions, and static gravity.  Assumes that maximum acceleration and maximum static
 * gravity do not occur at the same time.  Uses the phase angles to include the time offset of maximum static
 * gravity and maximum acceleration.  The following keywords are declared:
 *
 ...
 */
class repDesignAccel : public Report
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
     ...
     */
    repDesignAccel(ofreq::ReportManager *ptIn);
...
private:
    ...
    static std::string KEY_LOCATION;    /**< Location for the local acceleration. */
    static std::string KEY_ORDER;   /**< Order of derivative. */
