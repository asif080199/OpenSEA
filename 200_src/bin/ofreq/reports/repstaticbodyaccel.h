 ...
 *---------------------------------------------------------------------------------------------------------------------
 *Dec 20, 2014	Nicholas Barczak		Initially Created
 *
\*-------------------------------------------------------------------------------------------------------------------*/
...
#ifndef REPSTATICBODYACCEL_H
#define REPSTATICBODYACCEL_H
#include "report.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief Report for body static acceleration.  (Gravity acceleration, translated into body coordinate system).
 *
 * Provides the components of maximum gravity force in the body coordinate system, accounting for maximum body
 * motions.  Based on 0th order derivative of body solution.  The input must specify the name of the body.
 * the following keywords are declared:
 *
 * KEY_BODY:        String.  Name of the body to associate with.
 */
class repStaticBodyAccel : public Report
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
     ...
     */
    repStaticBodyAccel(ofreq::ReportManager *ptIn);
