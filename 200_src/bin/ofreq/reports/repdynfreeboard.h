...
#ifndef REPDYNFREEBOARD_H
#define REPDYNFREEBOARD_H
#include "report.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief The Report for calculation of local dynamic freeboard on body.
 *
 * Calculates dynamic freeboard.  This is the difference in height between any local point on the body, and the local
 * point of wave elevation.  Dynamic freeboard can also be negative, which indicates green water on deck.  The following
 ...
 */
class repDynFreeboard : public Report
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
     ...
     */
    repDynFreeboard(ofreq::ReportManager *ptIn);
