...
//------------------------------------------Function Separator --------------------------------------------------------
repBodAcceleration::repBodAcceleration()
{
    //Assign a default value for the name.
    this->setName("Body Global Acceleration - Global Coordinate System");
...
//------------------------------------------Function Separator --------------------------------------------------------
repBodAcceleration::repBodAcceleration(ofreq::ReportManager *ptIn) : repBodAcceleration::repBodAcceleration()
{
    this->setManager(ptIn);
}

//------------------------------------------Function Separator --------------------------------------------------------
string repBodAcceleration::getClass()
{
    return "repBodyAcceleration";
}

//------------------------------------------Function Separator --------------------------------------------------------
std::string repBodAcceleration::getFileName()
{
    return "accbody.out";
}
