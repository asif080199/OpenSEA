...
//######################################### Class Separator ###########################################################
/**
 * @brief Report for global solution to Body motions, in global coordinate system.
 *
 * Provides the solution of the Body motions, in each degree of freedom, for the specified body and order of
 * derivative.  Results are provided in the global coordinate system.  The input must specify the order of derivative
