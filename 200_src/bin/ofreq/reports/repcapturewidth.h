...
#ifndef REPCAPTUREWIDTH_H
#define REPCAPTUREWIDTH_H
#include "report.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief The Report for calculation of body capture width.
 *
 * Capture width is based on calculation of another body power object.  The capture width is a measurement of
 * efficiency, based on extracted power.  Capture width is a single number.  The Report requires reference to
 * another Report for power calculation.  The Capture width changes, depending on what terms are included in the
 * Power calculation.  Thus, the capture width needs to reference another Power object to get the appropriate
 * calculation.  THe capture width provides a total efficiency, summing extracted power for all motion variables.
 ...
 */
class repCaptureWidth : public Report
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
     ...
     */
    repCaptureWidth(ofreq::ReportManager *ptIn);
...
private:
    ...
    //------------------------------------------Function Separator ----------------------------------------------------
    /**
     * @brief Calculates wave power per unit meter of wave crest.
     *
     * This is the denominator term used to calculate the capture width.
