...
#ifndef DICTHYDROMASS_H
#define DICTHYDROMASS_H
...
//######################################### Class Separator ###########################################################
/**
 * The dictHydroMass class interprets the input file hydrodamp.out
 *
 * The hydromass.out input file is a set of reactive forces, associted with a specific order of derivative.
...
public:
     ...
     */
    dictHydroMass(osea::HydroReader *parent);
