...
#ifndef DICTCROSSMASS_H
#define DICTCROSSMASS_H
...
//######################################### Class Separator ###########################################################
/**
 * The dictCrossMass class interprets the input file crossmass.out
 *
 * The crossmass.out input file is a set of crossbody forces, associted with a specific order of derivative.
 ...
 * a single static variable.  ORD = 2 for this class.
 *
 * @sa Dictionary
 * @sa FileReader
 * @sa HydroReader
 */
class dictCrossMass : public dictCrossReact
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictCrossMass(osea::HydroReader *parent);
