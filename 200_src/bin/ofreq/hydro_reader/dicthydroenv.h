...
#ifndef DICTHYDROENV_H
#define DICTHYDROENV_H
 ...
 * @sa FileReader
 */
class dictHydroEnv : public Dictionary
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictHydroEnv(osea::HydroReader *parent);
...
private:
    ...
    static std::string OBJECT_PHYSICS; /**< String designation for the physics object. */


    //------------------------------------------Function Separator ----------------------------------------------------
    //Keyword name constants
    static std::string KEY_DEPTH; /**< String designation for the depth keyword. */
    static std::string KEY_DENSITY; /**< String designation for the density keyword. */
    static std::string KEY_GRAVITY; /**< String designation for the gravity keyword. */
    static std::string KEY_AMP; /**< String designation for the wave amplitude keyword. */

};

}   //Namespace ofreq

#endif // DICTHYDROENV_H
