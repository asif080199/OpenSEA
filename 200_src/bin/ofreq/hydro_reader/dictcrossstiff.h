...
#ifndef DICTCROSSSTIFF_H
#define DICTCROSSSTIFF_H
...
//######################################### Class Separator ###########################################################
/**
 * The dictCrossStiff class interprets the input file crossstiffness.out
 *
 * The crossstiffness.out input file is a set of crossbody forces, associted with a specific order of derivative.
 ...
 * a single static variable.  ORD = 0 for this class.
 *
 * @sa Dictionary
 * @sa FileReader
 * @sa HydroReader
 */
class dictCrossStiff : public dictCrossReact
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictCrossStiff(osea::HydroReader *parent);
