...
#ifndef DICTHYDRODIRECTION_H
#define DICTHYDRODIRECTION_H
 ...
 * @sa FileReader
 */
class dictHydroDirection : public Dictionary
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictHydroDirection(osea::HydroReader *parent);
...
private:
    ...
    static std::string KEY_DIRECTION; /**< Key for wave directions specification. */

};

}   //Namespace ofreq

#endif // DICTHYDRODIRECTION_H
