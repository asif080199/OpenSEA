...
#ifndef DICTHYDROSTIFF_H
#define DICTHYDROSTIFF_H
...
//######################################### Class Separator ###########################################################
/**
 * The dictHydroStiff class interprets the input file hydrostiffness.out
 *
 * The hydrostiffness.out input file is a set of reactive forces, associted with a specific order of derivative.
 ...
 * @sa HydroReader
 */
class dictHydroStiff : public dictHydroReact
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictHydroStiff(osea::HydroReader *parent);
