...
#ifndef DICTFORCEEXCITE_H
#define DICTFORCEEXCITE_H
...
//######################################### Class Separator ###########################################################
/**
 * The dictForceExcite class reads in excitation forces from the input file forceexcite.out.
 *
 ...
 * @sa HydroReader
 */
class dictForceExcite : public Dictionary
{
    Q_OBJECT
//==========================================Section Separator =========================================================
public:
     ...
     */
    dictForceExcite(osea::HydroReader *parent);
