...
//######################################### Class Separator ###########################################################
#ifndef SEAMODEL_SINGLEDIRECTION_H
#define SEAMODEL_SINGLEDIRECTION_H
...
//######################################### Class Separator ###########################################################
/**
 * @brief The SeaModel_SingleDirection class creates the model for a full sea environment.
 *
 * This SeaModel implements a single direction wave distribution.  It assumes a single primary wave direction, with
 * further waves distributed around that primary direction.
 ...
 *
 * This implementation requires you to only define a single wave spectrum and associated wave direction.  The
 ...
 */
class SeaModel_SingleDirection : public SeaModel
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
...
#endif // SEAMODEL_SINGLEDIRECTION_H
