...
//######################################### Class Separator ###########################################################
#ifndef SEAMODEL_UNIFORM_H
#define SEAMODEL_UNIFORM_H
#include "seamodel.h"
...
//######################################### Class Separator ###########################################################
/**
 * @brief The SeaModel_Uniform class creates the model for a full sea environment, independent of direction.
 *
 * This SeaModel implements a single wave spectrum, independent of wave direction.  It will output the same wave
 * amplitude, regardless of wave direction input.  A wave direction is still required for input, but the
 * SeaModel does not use the variable.  This SeaModel is useful for comparing Body performance at different angles,
 * independent of wave energy in each wave direction.  Or any case where the user wants a simplified SeaModel that
 * is just one set of waves.
 *
 ...
 */
class SeaModel_Uniform : public SeaModel
{
//==========================================Section Separator =========================================================
public:
    //------------------------------------------Function Separator ----------------------------------------------------
