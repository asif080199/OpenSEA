...
public:
     ...
     */
    OutputsBody(const vector<Body> &listBod,
     ...
     */
    void setlistBody(const vector<Body> &listIn);
     ...
     */
    void setlistSolution(const vector<listSolution> &listIn);
     ...
     */
    void setlistFreq(const vector<double> &listIn);
     ...
     */
    void setlistWaveDir(const vector<double> &listIn);
