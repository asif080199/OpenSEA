...
\end{DoxyReturn}
\hypertarget{class_output_derived_a525d8eb4dbed1fd130614521c5d602c1}{\index{Output\-Derived@{Output\-Derived}!list\-Body@{list\-Body}}
\index{list\-Body@{list\-Body}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Body}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ {\bf Body} $>$ \& Output\-Derived\-::list\-Body (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_output_derived_a525d8eb4dbed1fd130614521c5d602c1}
...
\end{DoxyReturn}
\hypertarget{class_output_derived_abda178375c603cd2d2efcc0c5f9c1f10}{\index{Output\-Derived@{Output\-Derived}!list\-Body@{list\-Body}}
\index{list\-Body@{list\-Body}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Body}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Body} \& Output\-Derived\-::list\-Body (
\begin{DoxyParamCaption}
\item[{int}]{bod\-In}
\end{DoxyParamCaption}
)}}\label{class_output_derived_abda178375c603cd2d2efcc0c5f9c1f10}


Returns a reference to an individual \hyperlink{class_body}{Body} in the list of \hyperlink{class_body}{Body} objects. 


\begin{DoxyParams}{Parameters}
{\em bod\-In} & The integer index of the body you wish to retrieve from the list of \hyperlink{class_body}{Body} objects. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns the \hyperlink{class_body}{Body} object requested. Returned variable is passed by reference. 
\end{DoxyReturn}
\hypertarget{class_output_derived_aeca7e08a1c561ae61a7a97a59b05cbdf}{\index{Output\-Derived@{Output\-Derived}!list\-Freq@{list\-Freq}}
\index{list\-Freq@{list\-Freq}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Freq}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ double $>$ \& Output\-Derived\-::list\-Freq (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_output_derived_aeca7e08a1c561ae61a7a97a59b05cbdf}
...
\end{DoxyReturn}
\hypertarget{class_output_derived_ae630f20aca768c789851b82020e2a8c3}{\index{Output\-Derived@{Output\-Derived}!list\-Freq@{list\-Freq}}
\index{list\-Freq@{list\-Freq}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Freq}]{\setlength{\rightskip}{0pt plus 5cm}double \& Output\-Derived\-::list\-Freq (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
)}}\label{class_output_derived_ae630f20aca768c789851b82020e2a8c3}
...
\end{DoxyReturn}
\hypertarget{class_output_derived_a114e057d84f34e5138d077fd7f053898}{\index{Output\-Derived@{Output\-Derived}!list\-Wave\-Dir@{list\-Wave\-Dir}}
\index{list\-Wave\-Dir@{list\-Wave\-Dir}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Wave\-Dir}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ double $>$ \& Output\-Derived\-::list\-Wave\-Dir (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_output_derived_a114e057d84f34e5138d077fd7f053898}
...
\end{DoxyReturn}
\hypertarget{class_output_derived_a043a3621ac94b69cd16170a550bb3905}{\index{Output\-Derived@{Output\-Derived}!list\-Wave\-Dir@{list\-Wave\-Dir}}
\index{list\-Wave\-Dir@{list\-Wave\-Dir}!OutputDerived@{Output\-Derived}}
\subsubsection[{list\-Wave\-Dir}]{\setlength{\rightskip}{0pt plus 5cm}double \& Output\-Derived\-::list\-Wave\-Dir (
\begin{DoxyParamCaption}
\item[{int}]{index}
\end{DoxyParamCaption}
)}}\label{class_output_derived_a043a3621ac94b69cd16170a550bb3905}
...
\end{DoxyReturn}
\hypertarget{class_output_derived_ae94d577f4f58c2c1f8cb2c9c650d505c}{\index{Output\-Derived@{Output\-Derived}!ref\-Solution\-Set@{ref\-Solution\-Set}}
\index{ref\-Solution\-Set@{ref\-Solution\-Set}!OutputDerived@{Output\-Derived}}
\subsubsection[{ref\-Solution\-Set}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ {\bf Solution\-Set} $>$ \& Output\-Derived\-::ref\-Solution\-Set (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_output_derived_ae94d577f4f58c2c1f8cb2c9c650d505c}


Returns a vector of \hyperlink{class_solution_set}{Solution\-Set} objects. 

\begin{DoxyReturn}{Returns}
Returns a vector of \hyperlink{class_solution_set}{Solution\-Set} objects. Internal storage is just a set of pointers to the object. Variable is passed by reference. 
\end{DoxyReturn}
...
\hline
\end{DoxyParams}
\hypertarget{class_output_derived_ac5a137e45b7ff144d9c5d1a9d7e51a24}{\index{Output\-Derived@{Output\-Derived}!set\-List\-Body@{set\-List\-Body}}
\index{set\-List\-Body@{set\-List\-Body}!OutputDerived@{Output\-Derived}}
\subsubsection[{set\-List\-Body}]{\setlength{\rightskip}{0pt plus 5cm}void Output\-Derived\-::set\-List\-Body (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Body} $>$ \&}]{Input}
\end{DoxyParamCaption}
)}}\label{class_output_derived_ac5a137e45b7ff144d9c5d1a9d7e51a24}
...
\hline
\end{DoxyParams}
\hypertarget{class_output_derived_a40c5ed80faa1c509be5348c9765a756a}{\index{Output\-Derived@{Output\-Derived}!set\-List\-Freq@{set\-List\-Freq}}
\index{set\-List\-Freq@{set\-List\-Freq}!OutputDerived@{Output\-Derived}}
\subsubsection[{set\-List\-Freq}]{\setlength{\rightskip}{0pt plus 5cm}void Output\-Derived\-::set\-List\-Freq (
\begin{DoxyParamCaption}
\item[{vector$<$ double $>$ \&}]{Input}
\end{DoxyParamCaption}
)}}\label{class_output_derived_a40c5ed80faa1c509be5348c9765a756a}
...
\hline
\end{DoxyParams}
\hypertarget{class_output_derived_a4c6c59f99a371d7cae9a4930ef1cd094}{\index{Output\-Derived@{Output\-Derived}!set\-List\-Wave\-Dir@{set\-List\-Wave\-Dir}}
\index{set\-List\-Wave\-Dir@{set\-List\-Wave\-Dir}!OutputDerived@{Output\-Derived}}
\subsubsection[{set\-List\-Wave\-Dir}]{\setlength{\rightskip}{0pt plus 5cm}void Output\-Derived\-::set\-List\-Wave\-Dir (
\begin{DoxyParamCaption}
\item[{vector$<$ double $>$ \&}]{Input}
\end{DoxyParamCaption}
)}}\label{class_output_derived_a4c6c59f99a371d7cae9a4930ef1cd094}
...
\hline
\end{DoxyParams}
\hypertarget{class_output_derived_aa61b7866cca2a734af62fd8806bb1bc2}{\index{Output\-Derived@{Output\-Derived}!set\-Solution\-Set@{set\-Solution\-Set}}
\index{set\-Solution\-Set@{set\-Solution\-Set}!OutputDerived@{Output\-Derived}}
\subsubsection[{set\-Solution\-Set}]{\setlength{\rightskip}{0pt plus 5cm}void Output\-Derived\-::set\-Solution\-Set (
\begin{DoxyParamCaption}
\item[{vector$<$ {\bf Solution\-Set} $>$ \&}]{Input}
\end{DoxyParamCaption}
)}}\label{class_output_derived_aa61b7866cca2a734af62fd8806bb1bc2}
...
\begin{DoxyParams}{Parameters}
{\em Input} & The vector list of \hyperlink{class_solution_set}{Solution\-Set} objects. Variable is passed by reference. Variable is stored internally as a pointer. \\
\hline
\end{DoxyParams}
