...
struct qt_meta_stringdata_osea__ofreq__dictSeaEnv_t {
    QByteArrayData data[1];
    char stringdata[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_osea__ofreq__dictSeaEnv_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_osea__ofreq__dictSeaEnv_t qt_meta_stringdata_osea__ofreq__dictSeaEnv = {
    {
QT_MOC_LITERAL(0, 0, 23)
    },
    "osea::ofreq::dictSeaEnv"
};
...
const QMetaObject osea::ofreq::dictSeaEnv::staticMetaObject = {
    { &Dictionary::staticMetaObject, qt_meta_stringdata_osea__ofreq__dictSeaEnv.data,
      qt_meta_data_osea__ofreq__dictSeaEnv,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_osea__ofreq__dictSeaEnv.stringdata))
